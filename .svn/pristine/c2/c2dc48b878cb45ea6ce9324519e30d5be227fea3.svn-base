<template>
  <div style="height:100%;" >
    ...
    <div style="height:50px;" class="appCenterTop" >
      <el-input  style="width: 120px;" class="filter-item" placeholder="门店名称" v-model="listQuery.companyName" size="mini" >
      </el-input>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addT() {
        this.$router.push({ path: 'CompanyAdd', query: { 'clientId': this.listQuery.clientId, flag: 1 }})
      },
      handleUpdate(val) {
        this.$router.push({ path: 'CompanyUpdate', query: { 'clientId': this.listQuery.clientId, 'id': val, flag: 2 }})
      },
      handleWatch(val) {
        this.$router.push({ path: 'CompanyWatch', query: { 'clientId': this.listQuery.clientId, 'id': val, flag: 0 }})
      },
